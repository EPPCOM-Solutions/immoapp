# Eppkom FAQ - Erweitert für RAG-Optimierung

## Warum Self-Hosting statt Cloud-Lösungen?

**Kurze Antwort**: Bei Eppkom bleiben Ihre Daten auf deutschen Servern unter Ihrer Kontrolle - das ist der Unterschied zwischen DSGVO-Compliance und Datenschutz-Risiko.
...
**Konkret bei Eppkom**: Wir installieren alle Systeme (n8n, Typebot, PostgreSQL, Ollama-LLMs) auf Ihren oder unseren deutschen Hetzner-Servern. Sie haben Root-Zugriff, volle Audit-Logs und können jederzeit Datenschutz-Prüfungen durchführen.

## Was unterscheidet Eppkom von Standard-Chatbot-Anbietern?

**Kurze Antwort**: Wir bauen keine SaaS-Chatbots - wir bauen Ihre eigene KI-Infrastruktur.

**Detail**: Andere Anbieter (z.B. Voiceflow, Botpress-Cloud) sind Plattformen mit festen Preismodellen und Datensilos. Eppkom liefert Ihnen die komplette Technologie Stack ownership: eigene Server, eigene LLMs, eigene Datenbanken. Das bedeutet:
...
**Konkret**: Ein Kunde mit 500 Mitarbeitern zahlt bei SaaS-Anbietern oft 2000-5000 Euro pro Monat. Mit Eppkom: Einmalige Implementierung plus ca. 200 Euro pro Monat Server-Kosten. Nach 6 Monaten ROI erreicht.

## Wie funktioniert die RAG-Technologie bei Eppkom praktisch?
...
## Welche Datenquellen kann Eppkom anbinden?

Eppkom kann praktisch jede Datenquelle anbinden, die über eine API oder Datei-Export verfügbar ist:
...
**Vergleich**: SaaS-Chatbot-Plattformen kosten oft 500-5.000 Euro/Monat OHNE eigene Infrastruktur. Eppkom amortisiert sich typischerweise nach 4-8 Monaten.

## Wie sicher sind die Daten bei Eppkom?
