...
export default function Home() {
  ...
  const [settings, setSettings] = useLocalStorage<SearchSettings>('immo_settings', {
    ...
    activePortals: ['Kleinanzeigen', 'ImmoScout24', 'Immobilo', 'Regional']
  });
        ...
        <div className="px-8 pb-4 flex justify-between items-center z-40">
          <div className="flex flex-col">
            <div className="flex items-center gap-3 mb-1">
              <img src="https://www.eppcom.de/assets/images/Logo.webp" alt="EPPCOM" className="h-14 object-contain drop-shadow-md" />
